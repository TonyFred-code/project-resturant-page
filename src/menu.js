...
export function createMenuTab() {
    ...
    const menuItem1 = createMenuItem(coloratoImg, "Colorato Pizza","Pizza ingredients cheese garlic tomato toppings");
    menuTab.appendChild(menuItem1);

    const menuItem2 = createMenuItem(cremaImg, "Crema Pizza","Pizza ingredients cheese garlic tomato toppings");
    menuTab.appendChild(menuItem2);

    const menuItem3 = createMenuItem(disgustosoImg, "Disgustoso Pizza","Pizza ingredients cheese garlic tomato toppings");
    menuTab.appendChild(menuItem3);

    const menuItem4 = createMenuItem(pepeImg, "Pepe Pizza","Pizza ingredients cheese garlic tomato toppings");
    menuTab.appendChild(menuItem4);

    const menuItem5 = createMenuItem(gamberiImg, "Gamberi Pizza","Pizza ingredients cheese garlic tomato toppings");
    menuTab.appendChild(menuItem5);

    const menuItem6 = createMenuItem(pomodoroImg, "Pomodoro Pizza","Pizza ingredients cheese garlic tomato toppings");
